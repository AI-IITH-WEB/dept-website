...
DT_TP['1'] = new DataTable('#tablepress-1',{language:DT_language['en_US'],order:[],orderClasses:false,pagingType:'simple_numbers',info:false});
DT_TP['3'] = new DataTable('#tablepress-3',{language:DT_language['en_US'],order:[],orderClasses:false,pagingType:'simple_numbers',info:false});
DT_TP['4'] = new DataTable('#tablepress-4',{language:DT_language['en_US'],order:[],orderClasses:false,pagingType:'simple_numbers',info:false});
DT_TP['5'] = new DataTable('#tablepress-5',{language:DT_language['en_US'],order:[],orderClasses:false,pagingType:'simple_numbers',info:false});
});
